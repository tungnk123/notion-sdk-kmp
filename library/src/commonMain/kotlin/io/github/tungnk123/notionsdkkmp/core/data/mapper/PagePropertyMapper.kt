...
import io.github.tungnk123.notionsdkkmp.core.data.model.internal.dto.user.PartialUserDto
...
import io.github.tungnk123.notionsdkkmp.core.data.model.result.page.NotionPageProperty
...
internal fun PartialUserDto.toDomain(): NotionPartialUser =
    NotionPartialUser(
        id = id
    )