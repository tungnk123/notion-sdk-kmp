...
import io.github.tungnk123.notionsdkkmp.core.data.model.internal.dto.database.ChildDataSourceRef
import io.github.tungnk123.notionsdkkmp.core.data.model.internal.dto.database.DatabaseDto
import io.github.tungnk123.notionsdkkmp.core.data.model.result.database.ChildDataSource
import io.github.tungnk123.notionsdkkmp.core.data.model.result.database.NotionDatabase

fun DatabaseDto.toDomain(): NotionDatabase =
    NotionDatabase(
        id = id,
...
fun ChildDataSourceRef.toDomain(): ChildDataSource =
    ChildDataSource(
        id = id,
        name = name
    )
