...
import core.data.model.internal.response.RetrieveDatabaseSchemaProperty
import core.data.model.result.NotionDatabasePropertySchema

internal fun RetrieveDatabaseSchemaProperty.toDomain(): NotionDatabasePropertySchema = when (this) {
